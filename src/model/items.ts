...
export class CommentItem implements CommentItemInterface{
  ...
  get is_valid()
  {
    if(this.deleted==undefined && this.dead==undefined && this.type==="comment" && this._text && this._id)
    return true
    else
    return false
  }
  ...
  get id()
  {
    ...
    throw "Error: Cannot find comment id"
  }
  ...
  get by()
  {
    ...
    throw "Error: Cannot find comment author"
  }
...
export function useHeadline(props:{hn_id:number, component_state?: ()=> void}) : StoryItem{

  let init:StoryItem = {title:"", url:"", by:"", score:0, descendants:0, id:0,time:0, type:"", kids:[]};
